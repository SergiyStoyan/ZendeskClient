...
namespace GlobalHotKey
{
    ...
    public class HotKeyManager : IDisposable
    {
        ...
        public void Dispose()
        {
            ...
            var t = _windowHandleSource.Dispatcher.Thread.IsAlive;
            var d = _windowHandleSource.Dispatcher.HasShutdownStarted;
            _windowHandleSource.Dispatcher.Invoke((Action)delegate {//for unknown reason it is not called while invoked from finalizer (Dispatcher's thread IsAlive)
